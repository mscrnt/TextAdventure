...
class Tutorial(QObject):
    ...
    def __init__(self, game_ui: GameUI, game_manager):
        ...
        self.steps = [
            ...
            ("inventory", "Please click on 'Sword of Athena' in your inventory to begin."),
            ("notes", "When you click on an inventory item, It will show you the name and a short discription of the item \n \n Next up are Notes. Use the dropdown to select notes, then click on 'Thief's Confession' to continue."),
    ...
    def start(self):
        ...
        QTimer.singleShot(7000, self.next_step)  # Wait 5 seconds before moving to the next step
    ...
    def end_tutorial(self):
        ic("Tutorial completed")
        self.display_instruction("Tutorial completed! You're now ready to explore Odyssey and all its tales. Good luck!")
    ...
    def check_quest_log_selection(self, item):
        ...
        if "Read Email" in item.text():
            ...
            QTimer.singleShot(7000, self.next_step)  # Proceed to the next step after a 5-second delay
        else:
    ...
    def check_emails_selection(self, item):
        ...
        if item:
            ...
            QTimer.singleShot(7000, self.next_step)
        else:
    ...
    def check_inventory_selection(self, item):
        ...
        if "Sword of Athena" in item.text():
            ...
            self.display_instruction("Please select 'Sword of Athena' item to proceed.")
